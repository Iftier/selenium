...
public class Saucedemo {
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.findElement(By.cssSelector("#first-name")).sendKeys("IFTIAR");

        driver.findElement(By.cssSelector("#last-name")).sendKeys("Shaju");
        ...
        boolean ThankyouforyourorderDisplayed= driver.findElement(By.cssSelector("#checkout_complete_container > h2")).isDisplayed();
